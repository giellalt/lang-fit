...
These pages document the work on the [Tornedalen Finnish language model](https//github.com/giellalt/lang-fit).

## Resources

* [Meänkieli tools](https://giellatekno.uit.no/cgi/index.fit.eng.html)
