...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_fit to login script."
...
# the current dir:
if   test x${GTLANG_fit} = x ; then
	echo "WARNING: The variable \${GTLANG_fit} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_fit} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_fit} has the value:"
	echo "  ${GTLANG_fit}"
